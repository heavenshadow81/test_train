...
public class RS_Manger : PlayManager_PlayGround
{
    ...
    void ResetSlot()
    {
        ...
        int random = Random.Range(0, btnParent.childCount);

        //첫번째 버튼 초록색으로 바꾸고 스케일 1.1로 바꿈
        button = btnParent.GetChild(random).GetComponent<Image>();
