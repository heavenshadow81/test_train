...
public class MultiModal_Temp : vCatchDisplay, vCatchInput_iMmPlayer
{
    /*    [Space(10)]
    ...
    */
    ...
    new protected void Awake()
    {
        ...
        var existingObject = FindObjectOfType(GetType());

        if (existingObject != null && existingObject != this)
        {
            // 이미 존재하는 오브젝트가 있으면 이 오브젝트를 파괴
            Destroy(gameObject);
            return;
        }
        ...
        // 오브젝트가 유일한 경우에만 DontDestroyOnLoad 호출
