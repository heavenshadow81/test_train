...
public class ST_Manger : PlayManager_PlayGround
{
    ...
    void SettingSlot()
    {
        ...
        int random = Random.Range(1, buttons.Length);
    ...
    void ResetSlot()
    {
        buttons[0].sprite = sprite[2];
        buttons[0].transform.tag = "Orange";
        buttons[0].transform.DOScale(1.1f, 0.2f);
    }
