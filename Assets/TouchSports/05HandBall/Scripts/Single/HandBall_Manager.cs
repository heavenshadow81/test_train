...
namespace ML.T_Sports.HandBall
{
    ...
    public class HandBall_Manager : ContentsManagerBase
    {

        public GameState gamestate;
        public HandBall_GUI_Goal[] Goal_Texture;
        public Animation Goal_Effect;
        public HandBall_Result_Ctrl result;
        public HandBall_Cleaner cleaner;
        ...
        public static HandBall_Manager instance
        {
            get;
            private set;
        }
        ...
        public override void OnChangePropertyValue(ContentsPropertyType type, float prevValue, float newValue)
        {
            switch (type)
            {
                case ContentsPropertyType.GameMode:
                    if (newValue == 1)
                        UnityEngine.SceneManagement.SceneManager.LoadScene("Touch_Handball");
                    break;
            }
