...
namespace ML.T_Sports.HandBall
{
    ...
    public class Game_Manager_Multi : ContentsManagerBase
    {
        public GameState gamestate;

        public Animation Goal_Effect;
        public Animation TeamShift_Ani;
        public Handball_Cleaner_Multi cleaner;
        ...
        public static Game_Manager_Multi instance
        {
            get;
            private set;
        }
        ...
        public override void OnChangePropertyValue(ContentsPropertyType type, float prevValue, float newValue)
        {
            switch (type)
            {
                case ContentsPropertyType.GameMode:
                    if (newValue == 0)
                        UnityEngine.SceneManagement.SceneManager.LoadScene("05HandBall_Single_Mod");
                    break;
            }
