...
public class AVProLiveCameraGUIDisplay : MonoBehaviour
{
	...
	public Material Display_Unity;
	public RawImage UI_Display;
	...
	public void OnGUI()
	{
		...
		if (_liveCamera.OutputTexture != null)
		{
			...
			UI_Display.texture = _liveCamera.OutputTexture;
			Display_Unity.mainTexture = _liveCamera.OutputTexture;
