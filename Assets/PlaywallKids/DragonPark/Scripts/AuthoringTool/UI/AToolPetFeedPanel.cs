...
{
    /// <summary>
    /// 드래곤파크 드래곤 메뉴 - 먹이주기 창 (AToolCharacterDrawing.cs에서 복사함)
    /// </summary>
    public class AToolPetFeedPanel : AnimatablePanel
    {
        ...
        public override void BeginShow()
        {
            ...
            UITweener[] tweens = tutorial.GetComponents<UITweener>();
        ...
        public void Close()
        {
            if (MenuControl.sharedInstance != null)
                MenuControl.sharedInstance.ActivatePetMenu(userId, true);
            Hide();
        }
        ...
        private void _InitItemList()
        {
            ...
            {
                UISprite dummy = NGUITools.AddSprite(gameObject, iconAtlas, "icon_apple");
        ...
        public void OK()
        {
            ...
            else
            {
                ...
                fruit.userId = userId;
                fruit.dragon = SimpleInstantiatedTemplateControl.GetCurrentTemplate(userId).GetComponent<Dragon>();
                ...
                // stop the current motion of my dragon
                var dragonTmp = SimpleInstantiatedTemplateControl.GetCurrentTemplate(userId);
                if (dragonTmp != null)
                {
                    var motionList = dragonTmp.GetComponent<DragonMotionList>();
                    if (motionList != null) motionList.Stop();
                }
