...
{
    public enum eEndPointsMode { AUTO = 0, AUTOCLOSED, EXPLICIT }
    public enum eWrapMode { ONCE = 0, LOOP }

    public class SplineInterpolator : MonoBehaviour
    {
        private eEndPointsMode mEndPointsMode = eEndPointsMode.AUTO;
        ...
        class SplineNode
        {
            ...
            public SplineNode(Vector3 p, Quaternion q, float t, Vector2 io) { Point = p; Rot = q; Time = t; EaseIO = io; }
            public SplineNode(SplineNode o) { Point = o.Point; Rot = o.Rot; Time = o.Time; EaseIO = o.EaseIO; }
        }

        private List<SplineNode> mNodes = null;
        private string mState = "";
        private bool mRotations = false;

        private System.Action mOnEndCallback;
        ...
        public void StartInterpolation(System.Action endCallback, bool bRotations, eWrapMode mode)
        {
            if (mState != "Reset")
