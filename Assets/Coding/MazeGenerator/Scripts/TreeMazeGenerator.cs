...
public abstract class TreeMazeGenerator : BasicMazeGenerator
{
    ...
    private struct CellToVisit
    {
        public int Row;
        public int Column;
        public Coding.Direction MoveMade;

        public CellToVisit(int row, int column, Coding.Direction move)
        {
            Row = row;
            Column = column;
            MoveMade = move;
    ...
    public override void GenerateMaze()
    {
        ...
        mCellsToVisit.Add(new CellToVisit(Random.Range(0, RowCount), Random.Range(0, ColumnCount), Coding.Direction.Start));
        ...
        while (mCellsToVisit.Count > 0)
        {
            ...
            else if (!GetMazeCell(ctv.Row, ctv.Column).IsVisited && ctv.MoveMade != Coding.Direction.Left)
            {
            ...
            else if (!GetMazeCell(ctv.Row, ctv.Column).IsVisited && ctv.MoveMade != Coding.Direction.Back)
            {
            ...
            else if (!GetMazeCell(ctv.Row, ctv.Column).IsVisited && ctv.MoveMade != Coding.Direction.Right)
            {
            ...
            else if (!GetMazeCell(ctv.Row, ctv.Column).IsVisited && ctv.MoveMade != Coding.Direction.Front)
            {
            ...
            if (movesAvailableCount > 0)
            {
                switch (movesAvailable[Random.Range(0, movesAvailableCount)])
                {
                    ...
                    case Coding.Direction.Right:
                        mCellsToVisit.Add(new CellToVisit(ctv.Row, ctv.Column + 1, Coding.Direction.Right));
                        break;
                    case Coding.Direction.Front:
                        mCellsToVisit.Add(new CellToVisit(ctv.Row + 1, ctv.Column, Coding.Direction.Front));
                        break;
                    case Coding.Direction.Left:
                        mCellsToVisit.Add(new CellToVisit(ctv.Row, ctv.Column - 1, Coding.Direction.Left));
                        break;
                    case Coding.Direction.Back:
                        mCellsToVisit.Add(new CellToVisit(ctv.Row - 1, ctv.Column, Coding.Direction.Back));
                        break;
                }
            }
            else
