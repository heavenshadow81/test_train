...
public class MultiModalCrane : vCatchDisplay, vCatchInput_iMmPlayer
{
    /*    [Space(10)]
    ...
    */
    ...
    private List<int> touchCountArray = new List<int>();
    private bool _isFootCountCheck = false;
    new protected void Update()
    {
        ...
        //if (Clicks.Length > 0)
        //{
        //    //if (_isFootCountCheck == false)
        //    //{
        //    //    //_oldTouchCount = Clicks.Length;
        //    //    vMouse.TapDown(Clicks[0].x, Clicks[0].y, 0, 0, 1920, 1080);
        //    //    _isFootCountCheck = true;
        //    //}
        ...
        if (_isFootCountCheck)
        {
            if (touchCountArray.Count >= 5)
            {
                if (touchCountArray.Contains(1))
                {
                    touchCountArray.RemoveAt(0);
                    touchCountArray.Add(Drags.Length);
                }
                else
                {
                    _isFootCountCheck = false;
                    touchCountArray.Clear();
                    vMouse.TapOut();
                }
            }
            else
        ...
        if (Drags.Length > 0)
        {
            ...
            {
                //_oldTouchCount = Clicks.Length;
                vMouse.TapDown(Drags[0].x, Drags[0].y, 0, 0, 1920, 1080);
                _isFootCountCheck = true;
            }
